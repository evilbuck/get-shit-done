...
@~/.config/opencode/gsd/workflows/research-project.md
@~/.config/opencode/gsd/templates/research-project/SUMMARY.md
@~/.config/opencode/gsd/templates/research-project/STACK.md
@~/.config/opencode/gsd/templates/research-project/FEATURES.md
@~/.config/opencode/gsd/templates/research-project/ARCHITECTURE.md
@~/.config/opencode/gsd/templates/research-project/PITFALLS.md
</execution_context>
