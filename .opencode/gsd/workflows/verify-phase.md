...
- ~/.config/opencode/gsd/references/goal-backward.md (derivation process)
- ~/.config/opencode/gsd/references/verification-patterns.md (detection patterns)
- ~/.config/opencode/gsd/templates/verification-report.md (output format)
</required_reading>
...
See ~/.config/opencode/gsd/references/goal-backward.md for detailed derivation guidance.
</step>
...
See ~/.config/opencode/gsd/templates/verification-report.md for complete template.
</step>
