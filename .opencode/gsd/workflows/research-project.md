...
1. ~/.config/opencode/gsd/templates/research-project/SUMMARY.md
2. ~/.config/opencode/gsd/templates/research-project/STACK.md
3. ~/.config/opencode/gsd/templates/research-project/FEATURES.md
4. ~/.config/opencode/gsd/templates/research-project/ARCHITECTURE.md
5. ~/.config/opencode/gsd/templates/research-project/PITFALLS.md
...
- Read ~/.config/opencode/gsd/templates/research-project/STACK.md for format
...
Use this template structure:
- Read ~/.config/opencode/gsd/templates/research-project/FEATURES.md for format
...
Use this template structure:
- Read ~/.config/opencode/gsd/templates/research-project/ARCHITECTURE.md for format
...
Use this template structure:
- Read ~/.config/opencode/gsd/templates/research-project/PITFALLS.md for format
